...
@TeleOp(name="Proto", group="Ftc 2017")
...
//        dt.runWithoutEncoders();
    ...
    public void loop() {
        ...
        if (gamepad1.left_bumper) x = 0;
        if (gamepad1.right_bumper) y = 0;
        dt.paraDrive(x, y, theta);
    ...
    void composeTelemetry() {
        ...
        telemetry.addLine()
                .addData("d,v", new Func<String>() {
                 @Override public String value() {
                    return String.format("%s, %s" , imu.getPosition().toString(),
                            imu.getVelocity().toString());
                ...
                .addData("rgb", new Func<String>() {
                    @Override public String value() {
                        return String.format("%d, %d, %d" ,
                                ja.cs.red(), ja.cs.green(), ja.cs.blue()
                        );
